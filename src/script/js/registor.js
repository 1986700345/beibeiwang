	...
	aInput[1].onfocus=function(){
		...
		aInput[1].oninput=function(){//改变即触发
			...
			if(this.value.length>=6 && this.value.length<=16){
				...
				switch(num){
					case 1: notice[1].innerHTML='弱'; notice[1].style.color='#FF0000'; passwordflag=false; break;
					case 2:
					case 3: notice[1].innerHTML='中'; notice[1].style.color='orange';passwordflag=true; break;
					case 4: notice[1].innerHTML='强'; notice[1].style.color='green';passwordflag=true; break;
				}
			}else{
